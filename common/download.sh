...
if [[ " $@ " == *" v8 "* ]]; then
    sudo bash -c "$(curl -sLfo- https://raw.githubusercontent.com/RioTwWks/hiddify-config/main/common/download_install.sh)"
    exit $?
fi
...
if [[ "$branch" == v* ]]; then
    ...
    base_url="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/tags/$branch/"
elif [[ "$branch" == "beta" ]]; then
    # If input is 'release' or empty, use main
    base_url="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/beta/"
elif [[ "$branch" == "dev" ]]; then
    # If input is 'release' or empty, use main
    base_url="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/dev/"
else
    # Otherwise, use the input as a branch name
    base_url="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/main/"
fi
