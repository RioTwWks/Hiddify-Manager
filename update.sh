...
function main() {
    ...
    update_script="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/main/common/download.sh"
    ...
    develop)
        ...
        update_script="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/dev/common/download.sh"
        ;;
    beta)
        latest_panel=$(get_pre_release_version hiddify-panel)
        latest_manager=$(get_pre_release_version hiddify-manager)
        update_script="https://raw.githubusercontent.com/RioTwWks/Hiddify-Manager/refs/heads/beta/common/download.sh"
        ;;
    release)
